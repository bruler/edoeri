...
edoeri-Linux-Debug:
	 $(PROJECTBUILD) edoeri Linux Debug  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

edoeri-Linux-DebugGame:
	 $(PROJECTBUILD) edoeri Linux DebugGame  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

edoeri-Linux-Shipping:
	 $(PROJECTBUILD) edoeri Linux Shipping  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

edoeri-Linux-Test:
	 $(PROJECTBUILD) edoeri Linux Test  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

edoeri:
	 $(PROJECTBUILD) edoeri Linux Development  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

edoeriEditor-Linux-Debug:
	 $(PROJECTBUILD) edoeriEditor Linux Debug  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

edoeriEditor-Linux-DebugGame:
	 $(PROJECTBUILD) edoeriEditor Linux DebugGame  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

edoeriEditor-Linux-Shipping:
	 $(PROJECTBUILD) edoeriEditor Linux Shipping  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

edoeriEditor-Linux-Test:
	 $(PROJECTBUILD) edoeriEditor Linux Test  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

edoeriEditor:
	 $(PROJECTBUILD) edoeriEditor Linux Development  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)
