...
unrealRootPath=/home/cortana/UnrealEngine-4.12.5-release
edoeriRootPath=/home/cortana/Projects/UnrealProjects/edoeri

gameProjectFile=/home/cortana/Projects/UnrealProjects/edoeri/edoeri.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(edoeriSource.pri)
include(edoeriHeader.pri)
include(edoeriConfig.pri)
include(edoeriIncludes.pri)
include(edoeriDefines.pri)
...
edoeri-Linux-Debug.commands = $$build edoeri Linux Debug  -project="\"$$gameProjectFile\"" $$args
edoeri-Linux-DebugGame.commands = $$build edoeri Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
edoeri-Linux-Shipping.commands = $$build edoeri Linux Shipping  -project="\"$$gameProjectFile\"" $$args
edoeri-Linux-Test.commands = $$build edoeri Linux Test  -project="\"$$gameProjectFile\"" $$args
edoeri.commands = $$build edoeri Linux Development  -project="\"$$gameProjectFile\"" $$args

edoeriEditor-Linux-Debug.commands = $$build edoeriEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
edoeriEditor-Linux-DebugGame.commands = $$build edoeriEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
edoeriEditor-Linux-Shipping.commands = $$build edoeriEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
edoeriEditor-Linux-Test.commands = $$build edoeriEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
edoeriEditor.commands = $$build edoeriEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	edoeri-Linux-Debug \
	edoeri-Linux-DebugGame \
	edoeri-Linux-Shipping \
	edoeri-Linux-Test \
	edoeri \
	edoeriEditor-Linux-Debug \
	edoeriEditor-Linux-DebugGame \
	edoeriEditor-Linux-Shipping \
	edoeriEditor-Linux-Test \
	edoeriEditor \
